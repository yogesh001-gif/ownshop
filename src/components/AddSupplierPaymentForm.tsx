...
export default function AddSupplierPaymentForm({ purchaseId, supplierId, dueAmount }: AddSupplierPaymentFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const res = await fetch('/api/payments/supplier', {
      ...
      body: JSON.stringify({ supplierId, purchaseId, amount })
    });
